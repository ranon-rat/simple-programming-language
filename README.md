...
- [_]**Module system**: Basic support for code organization across files
- [x] **Arrays**.
- [_]**FFI (Foreign Function Interface)**: While interesting, this would likely be better implemented in a C++ version of the interpreter
